...
class OuluSR(data.Dataset):
    ...
    Args:
        ...
        there are 240,240,240,240,240,240,480 images in data
        we choose 24,24,24,24,24,24,48 images for testing
    ...
    def __init__(self, split='Training', fold = 1, transform=None):
        ...
        self.data = h5py.File('./data/g_SR144_Oulu_144_data.h5', 'r', driver='core')

        number = len(self.data['data_label']) #981
        sum_number = [0,240,480,720,960,1200,1440,1920] # the sum of class number
        test_number = [24,24,24,24,24,24,48] # the number of each class
